...
(ert-deftest eldev-test-prepare-project-available-1 ()
...
(ert-deftest eldev-test-prepare-project-available-2 ()
  (let ((eldev--test-project "dependency-a"))
    (eldev--test-delete-cache)
