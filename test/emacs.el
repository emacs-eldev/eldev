...
(ert-deftest eldev-test-emacs-1 ()
  (eldev--test-run "trivial-project" ("emacs" "--batch")
    (should (= exit-code 0))))

(ert-deftest eldev-test-emacs-2 ()
...
(ert-deftest eldev-test-emacs-missing-dependency-1 ()
