...
* You can also use {uri-documentation}#local-sources[package sources
  local to your machine], even those that don’t use Eldev (some
  restrictions still apply).  This is similar to Cask linking, but
