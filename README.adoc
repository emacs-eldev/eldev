...
Certain files macros in Elisp cannot be byte-compiled without
...
It is a good idea to specify this as the default in file `Eldev` for
projects that need this setting:
