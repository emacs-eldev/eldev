...
;;; Copyright (C) 2019-2026 Paul Pogonyshev
...
(defun eldev--build-target-entries (targets builder builder-name sources)
  ...
  (when builder
    (eldev--build-collect-targets targets builder builder-name)))

(defun eldev--build-collect-targets (targets builder builder-name)
  (eldev-named-step nil (eldev-format-message "collecting targets of builder `%s'" builder-name)
